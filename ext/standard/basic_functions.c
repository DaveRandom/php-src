...
#define REGISTER_MATH_CONSTANT(x)  REGISTER_DOUBLE_CONSTANT(#x, x, CONST_CS | CONST_PERSISTENT)
	...
	REGISTER_LONG_CONSTANT("TIME_SCALE_SECS",  TIME_SCALE_SECS,  CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIME_SCALE_MSECS", TIME_SCALE_MSECS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIME_SCALE_USECS", TIME_SCALE_USECS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIME_SCALE_NSECS", TIME_SCALE_NSECS, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("TIME_FORMAT_INT",  TIME_FORMAT_INT,  CONST_CS | CONST_PERSISTENT);
